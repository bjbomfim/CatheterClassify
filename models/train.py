...
def train(train_ids, val_ids, return_train_path = "/content/drive/MyDrive/Colab Notebooks/CatheterClassify/trainresults/2024_03_21_20_03_25_PM"):
    ...
    model_checkpoint = ModelCheckpoint(os.path.join(results_dir, 'best_segmentation_model.h5'), 
                                    ...
                                    save_best_only=True)
    save_data_results = saveResults.SaveDataTrainResults(path_to_get_resultus= results_dir, path_to_save = "/content/drive/MyDrive/Colab Notebooks/CatheterClassify/trainresults")
